...
namespace Group8_Homework_3A
{
    public partial class MainForm : BaseForm
    {
        ...
        {
            Elliptic_Child ellipseKid = new Elliptic_Child(userPreferences.Height, userPreferences.Width);
            ellipseKid.Show();
        }

        private void rectangularFormToolStripMenuItem_Click(object sender, EventArgs e)
        {
            RectangularChild rectangularKid = new RectangularChild(userPreferences.Height, userPreferences.Width);
            rectangularKid.Show();
        }

        private void groupNamesUserControl1_MouseDown(object sender, MouseEventArgs e)
        {
